    ...
    return `
                <tr class="tr-default">
                    ...
                    <td class="input_column">
                        ...
                        <input type="date" id="${tablePrefix}date_range_input_from" value=${formattedFirstDay} class="${radioDateRangeEnableCss}" value="">
                        <div class="ml-2 mr-2">To</div>
                        <input type="date" id="${tablePrefix}date_range_input_to" value=${formattedToday} class="${radioDateRangeEnableCss}" value="">
                    </td>
                </tr>
                <tr class="tr-default">
                    ...
                    <td class="input_column">
                        ...
                        <select name="" id="${tablePrefix}date_range_selector" class="${dageRangeSelectorDisableCss}" disabled>
                            ${optionsHTML}
                        </select>
                        </label>
                    </td>
